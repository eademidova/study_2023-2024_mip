...
![Отчёт по модели оформления заказов в интернет-магазине с распределением поступления заказов Norm(3.14, 1.7) и времени оформления клиентов Norm(6.66, 1.7)](image/4.png){#fig:004 width=90%}
